  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 dark:from-gray-900 via-white dark:via-gray-950 to-green-50 dark:to-gray-900">
        ...
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="font-bold text-xl text-gray-900 dark:text-white">SIPRO</h1>
                <p className="text-sm text-gray-600 dark:text-gray-400">Sistema Inteligente de Preparación para las Pruebas Saber Pro</p>
              </div>
            </div>
            <div className="flex items-center gap-3">
      ...
      <main className="max-w-7xl mx-auto px-6 py-8">
        {/* Welcome Section */}
        <div className="mb-8">
          <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-2">¡Bienvenida de nuevo, María!</h2>
          <p className="text-gray-600 dark:text-gray-400">Continúa mejorando tus habilidades para el Saber Pro</p>
        </div>
                  ...
                  {competenciasData.map((comp, index) => (
                    <div key={index}>
                      <div className="flex justify-between mb-2">
                        <span className="text-sm font-medium text-gray-700 dark:text-gray-300">{comp.competencia}</span>
                        <span className="text-sm font-semibold text-blue-600 dark:text-blue-400">{comp.puntaje}/100</span>
                      </div>
                  ...
                  {historialPruebas.map((prueba) => (
                    ...
                    >
                      <div className="flex justify-between items-start mb-2">
                        <span className="text-xs text-gray-500 dark:text-gray-400">{prueba.fecha}</span>
                        <span className="text-sm font-bold text-blue-600 dark:text-blue-400">
                          {prueba.puntaje} pts
                        </span>
                      </div>
                      <p className="text-sm font-medium text-gray-900 dark:text-gray-100">{prueba.tipo}</p>
            ...
            <Card className="shadow-md border-gray-200">
              ...
              <CardContent>
                <div className="space-y-4">
                  <div>
                    <div className="flex justify-between mb-2">
                      <span className="text-sm text-gray-700 dark:text-gray-300">Nivel actual</span>
                      <span className="text-sm font-semibold text-purple-600 dark:text-purple-400">Avanzado</span>
                    </div>
                    <Progress value={75} className="h-2" />
                  </div>
                  <div className="pt-4 border-t dark:border-gray-800">
                    <p className="text-xs text-gray-500 dark:text-gray-400 mb-2">Próxima meta</p>
